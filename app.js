var clap = new Audio('drumKit/sounds/clap.wav');
var hihat = new Audio('drumKit/sounds/hihat.wav');
var kick = new Audio('drumKit/sounds/kick.wav');
var openhat = new Audio('drumKit/sounds/openhat.wav');
var boom = new Audio('drumKit/sounds/boom.wav');
var ride = new Audio('drumKit/sounds/ride.wav');
var snare = new Audio('drumKit/sounds/snare.wav');
var tom = new Audio('drumKit/sounds/tom.wav');
var tink = new Audio('drumKit/sounds/tink.wav');
